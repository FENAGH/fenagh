  ...
  >
    ...
    >
      <picture>
        <source 
          type="image/png" 
          srcSet={require('../../images/hero_image_mobile_custom@2x.png')} 
          media="(max-width:768px)"
        />
        <source 
          type="image/png" 
          srcSet={require('../../images/hero_image_desktop_custom@2x.png')} 
          media="(min-width:769px)"
        />
        <Image 
          alt="Fenagh Honduras" 
          src={require('../../images/hero_image_desktop_custom@2x.png')} 
          w="95%"
          m="0 auto"
        />
      </picture>
