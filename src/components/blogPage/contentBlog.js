  ...
  return (
    <Container py="1rem">
      <Content>
        ...
        <Text>Once ready for harvest, conventional lettuce is machine-picked and processed, which can cause <a href="https://www.nytimes.com/2017/07/27/climate/nitrogen-fertilizers-climate-change-pollution-waterways-global-warming.html" target="_blank"  rel="noopener">quality issues and waste from mechanical damage</a>. Because it’s grown outdoors with pesticides, conventional lettuce is often triple-washed to reduce the risk of contamination like that which caused the <a href="https://www.nytimes.com/2017/07/27/climate/nitrogen-fertilizers-climate-change-pollution-waterways-global-warming.html" target="_blank"  rel="noopener">recent E. Coli outbreak</a> — an incredibly water costly process. It’s then vacuum cooled, packaged, and picked up by long-haul refrigerated diesel trucks that transport it thousands of miles across the country. Once it reaches its destination, it’s handed off to multiple short-haul distributors, who eventually deliver it to retailers.</Text>
